...
<style>
	body{
		...
		background: linear-gradient(338deg, rgba(0,0,0,1) 14%, rgba(13,10,16,10) 40%, rgba(13,120,120,1) 53%, rgba(0,0,0,12) 92%);
	    /*background: #007bff;*/
	}
	main#main{
		width:100%;
  	...
  	<div class="container">
  		...
  		<div id="login-center" class="row justify-content-center align-self-center w-100">
  			<div class="d-flex justify-content-center align-items-center w-100">
  				<span  class="m-4 p-2">
  				<h1 class="text-gradient-primary text-center" style="font-size: 4	rem"><b><i class="fas fa-headphones-alt text-gradient-primary"></i></b></h1>
  				<h2 class="text-gradient-primary"><b>DuongMP3</b></h2>
  				</span>
  			</div>
